# Generated by Django 3.2.18 on 2023-03-04 13:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.IntegerField(choices=[(0, 'Project'), (1, 'Post')], default=0)),
            ],
        ),
        migrations.CreateModel(
            name='Project',
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='proj_categories', to='woodapp.category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='post_categories', to='woodapp.category')),
